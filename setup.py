...
setup(
    ...
    packages=['FreezeUI'],
    data_files=[('bitmaps', ['FreezeUI/assets/icon.gif','FreezeUI/assets/icon.ico','FreezeUI/assets/msi_text.png','FreezeUI/assets/exe_text.png','FreezeUI/assets/pyicon.svg'])],
